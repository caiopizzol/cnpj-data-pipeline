...
- **`pais`** — os códigos órfãos presentes na tabela SERPRO são resolvidos (`150`, `151`, `200`, `321`, `359`, `367`, `393`, `449`, `498`, `578`, `678`, `693`, `699`, `737`, `755`, `994`). O `150` fica com confiança média (divergência de rótulo Jersey/Guernsey).
- **`pais` 008, 009, 015, 042, 452** — não resolvidos de propósito: ausentes de toda tabela oficial.
